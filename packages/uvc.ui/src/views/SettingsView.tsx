  ...
  return (
    <div className="settings-home">
      <header className="settings-hero">
        <h1>Settings</h1>
        <p>Manage the devices used to document UVC cycles, role authority, data, memory, and application configuration.</p>
      </header>

      {onToggleTheme && (
        <section className="settings-group">
          <div className="settings-group__header"><h2>Appearance</h2></div>
          <button className="action-button" type="button" onClick={onToggleTheme}>
      ...
      <section className="settings-group">
        ...
        <Link className="settings-link-card" to="/settings/devices">
          ...
          <span className="settings-link-card__copy">
            <strong>Devices, connections &amp; trust</strong>
            <span>Hardware, pairing, verified identities, and connection controls</span>
          </span>
      ...
      <section className="settings-group">
        ...
        <Link className="settings-link-card" to="/roles">
          <span className="settings-link-card__icon" style={{ backgroundColor: 'var(--uvc-surface-subtle)', color: 'var(--uvc-muted)' }}>
      ...
      <section className="settings-group">
        <div className="settings-group__header"><h2>Data</h2></div>
        <Link className="settings-link-card" to="/settings/data">
          <span className="settings-link-card__icon"><Database aria-hidden="true" /></span>
          <span className="settings-link-card__copy">
            <strong>Data &amp; Memory</strong>
            <span>Export your records as an Excel workbook and browse saved memories.</span>
          </span>
          <ChevronRight aria-hidden="true" />
        </Link>
      </section>
        ...
        <section className="settings-group">
          <div className="settings-group__header">
            <div>
              ...
              <p>Preferences for this application.</p>
            </div>
