    ...
    if (items.length) {
        ...
        items.forEach(function(item) {
            ...
            if ( !hasOwnProp.call(item, 'longname') ) {
                ...
                itemsNav += '<li>' + linktoFn(item.longname, displayName.replace(/\b\.(module|event):[tj]s/g, '')) + '</li>';
...
exports.publish = function(taffyData, opts, tutorials) {
    ...
    // EDIT hasenstein@yahoo.com: I want the methods listed in the order they are in the code
    ...
    Object.keys(helper.longnameToUrl).forEach(function(longname) {
        ...
        if (myModules.length) {
            myModules.forEach(m => m.name = longname.replace(/.module:ts/, ''));
