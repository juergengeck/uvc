...
import type { AIProviderConfig, LocalAISettings, CloudAISettings } from '../../types/ai';

// Type aliases to match the new component structure 
type LocalAIProviderConfig = AIProviderConfig & { id: 'local', settings: LocalAISettings };
type CloudAIProviderConfig = AIProviderConfig & { id: 'cloud', settings: CloudAISettings };
      ...
      <>
        ...
        {config.enabled && (
          <>
            ...
            <List.Item
              title={t('settings.ai.providers.cloud.endpoint.title')}
              description={t('settings.ai.providers.cloud.endpoint.description')}
              style={styles.settingsItem}
              right={() => (
                <TextInput
            ...
            <List.Item
              title={t('settings.ai.providers.cloud.temperature')}
              description={t('settings.ai.providers.cloud.temperatureDescription')}
              style={styles.settingsItem}
              right={() => (
                <TextInput
                  value={settings.temperature.toString()}
            ...
            <List.Item
              title={t('settings.ai.providers.cloud.maxTokens')}
              description={t('settings.ai.providers.cloud.maxTokensDescription')}
              style={styles.settingsItem}
              right={() => (
                <TextInput
